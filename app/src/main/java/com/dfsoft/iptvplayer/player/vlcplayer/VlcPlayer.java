...
public class VlcPlayer implements Handler.Callback,IVLCVout.OnNewVideoLayoutListener {
...
//                start();
    ...
    private void attachSurface() {
        if (!mMediaPlayer.getVLCVout().areViewsAttached() && isAttached && !isAttachedSurface) {
            ...
            AWindowHacker hacker = new AWindowHacker((AWindow) mMediaPlayer.getVLCVout());
            hacker.attachSurfaceSlave(surfaceVideo,surfaceSlave,  this);
...
//            LogUtils.i("异常  isAttachedSurface");
        ...
        boolean isLoadMedia = loadMedia(mLibVLC);
        attachSurface();

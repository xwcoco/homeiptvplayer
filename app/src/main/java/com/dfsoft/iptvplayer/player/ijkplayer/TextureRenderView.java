...
public class TextureRenderView extends TextureView implements IRenderView {
    ...
    protected void onVisibilityChanged(View changedView, int visibility) {
        ...
        if (mSurfaceTextureListener != null && visibility == View.VISIBLE) {
            if (mSurfaceTextureListener.mSurfaceTexture != null) {
                setSurfaceTexture(mSurfaceTextureListener.mSurfaceTexture);
            }
        }
    }
    ...
    public Bitmap getLastFrame() {
        return mSurfaceTextureListener.lastBitMap;
    }
    ...
    private static final class Listener implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            lastBitMap = mWeakSurfaceView.get().getBitmap();
        }
